...
FORTUNE_DATA = [
    {"score": 98, "items": [
        {"level": "大吉·乾卦上九", "desc": "禄存星耀财帛宫，地产投资正逢时，金蟾献宝登门来，契约一签百事兴", "advice": "今天运气爆棚！有人找你合作、签合同的话大胆答应，赚钱机会就在眼前，千万别犹豫"},
        {"level": "大吉·离卦九五", "desc": "文昌星临命宫旺，笔墨生辉百事成，才华锋芒不可挡，名利双收喜事临", "advice": "今天脑子特别好使，写东西、做方案都很顺，适合表现自己，有啥想法大胆说出来"},
    ]},
    {"score": 95, "items": [
        {"level": "大吉·坤卦六五", "desc": "紫微入命百煞消，四方贵气竞来朝，财星高照运势旺，逢凶化吉步步高", "advice": "今天出门容易遇到贵人帮忙，碰到好机会别不好意思，有人伸手就赶紧抓住"},
        {"level": "大吉·震卦九四", "desc": "天乙贵人扶身旁，所图之事皆吉祥，红鸾星动好姻缘，出门向南百事顺", "advice": "桃花运不错哦！单身的多出去走走，有对象的今天适合一起做点浪漫的事"},
    ]},
    {"score": 90, "items": [
        {"level": "大吉·巽卦九三", "desc": "禄马交驰财路宽，贵人指路破迷关，午时动身逢吉兆，西北藏有意外财", "advice": "中午之后做事效率会很高，可能还有意外的小惊喜，今天适合放开手脚干大事"},
        {"level": "大吉·兑卦九二", "desc": "金星入垣照命强，功名财帛俱昌旺，龙年吉月逢吉日，今日签文压群芳", "advice": "今天不管是工作还是生活都很顺，想做的事就去做，运气站在你这边"},
    ]},
    {"score": 85, "items": [
        {"level": "大吉·乾卦九五", "desc": "福德宫中吉星聚，财官双美照前程，辰时动身逢吉兆，遇木之人可助力", "advice": "好事正在路上，不用太着急，顺其自然就好，今天运气很稳，做啥都挺顺利的"},
        {"level": "大吉·艮卦九三", "desc": "山岳稳固根基深，积德行善福自临，贵人暗助拨云雾，吉星拱照百业兴", "advice": "稳稳当当就是最好的策略，身边有人在暗暗帮你，多做好事会有好回报"},
    ]},
    {"score": 80, "items": [
        {"level": "中吉·艮卦六二", "desc": "月德合日百事顺，稳步前行积厚福，不宜急进宜守成，向东一步有转机", "advice": "今天别太急，慢慢来反而更好，先把手头的事做好，好运会自己找上门来的"},
        {"level": "中吉·坎卦九五", "desc": "水星照命财运通，逢水之地得贵助，巳午之间利交涉，签约合作可为之", "advice": "上午到中午这段时间适合谈事情、签约合作，踏踏实实做，运气自然就来了"},
    ]},
    {"score": 75, "items": [
        {"level": "中吉·离卦六三", "desc": "文星拱照万事宜，心诚则灵得天助，今日宜静不宜动，守中待时福自来", "advice": "今天适合安安静静做自己的事，别到处跑，沉住气等一等，好事会来找你"},
        {"level": "中吉·震卦六五", "desc": "天德月德合时令，求谋有望得善缘，向南出行逢吉星，午时前后利交际", "advice": "中午前后适合社交，跟朋友聊聊天说不定有好消息，缘分来了记得抓住"},
    ]},
    {"score": 70, "items": [
        {"level": "中平·坤卦六三", "desc": "日月合璧照平安，无风无浪渡此关，平常心待非常事，守正不偏自安然", "advice": "今天平平稳稳的，没啥大事，保持平常心就好，平淡也是一种幸福呀"},
        {"level": "中平·巽卦六四", "desc": "风平浪静守本分，顺势而为莫强求，默默耕耘自有获，守得云开见月明", "advice": "别强求什么结果，默默做好自己的事就行，今天虽然普通但也挺安稳的"},
    ]},
    {"score": 65, "items": [
        {"level": "小吉·兑卦初九", "desc": "小有波折终归顺，耐心等待时来运，勿与口舌之人争，向西北方得小利", "advice": "今天可能会遇到点小波折，别跟人吵架，忍一忍就过去了，退一步海阔天空"},
        {"level": "小吉·乾卦初九", "desc": "潜龙勿用养精神，厚积薄发待时机，小事可为大事缓，步步为营稳前行", "advice": "小事可以处理，大事先缓缓别急着做决定，现在不适合冒险，养精蓄锐最重要"},
    ]},
    {"score": 60, "items": [
        {"level": "小吉·巽卦初六", "desc": "风过无痕事渐明，潜心积累待春风，今日不宜大动作，细水长流方为上", "advice": "今天别搞太大的动作，安安稳稳一点点来就好，少折腾，积少成多才是正道"},
        {"level": "小吉·坤卦初六", "desc": "履霜坚冰渐积成，点滴之功莫小觑，踏实行事人心服，终有一日厚积发", "advice": "踏踏实实做事别想捷径，现在的努力以后都会有回报的，别因为小利耽误大事"},
    ]},
    {"score": 55, "items": [
        {"level": "末吉·艮卦初六", "desc": "山重水复疑无路，柳暗花明静心候，寅卯之时宜处事，遇土之人可商议", "advice": "感觉有点困难也别灰心，转机就在前面，早上处理事情效果会好一些"},
        {"level": "末吉·离卦初九", "desc": "初出茅庐须谨慎，厉行节约莫轻率，守住本心不动摇，吉星迟早会眷顾", "advice": "做事小心一点别冲动，守住自己的节奏别被别人带跑，好运迟早会来的"},
    ]},
    {"score": 50, "items": [
        {"level": "末吉·坎卦初六", "desc": "水星伏令财路滞，宜守不宜轻出击，避开西南凶煞方，向东一步可化解", "advice": "今天不太适合花大钱或者做投资，管好钱包别冲动消费，耐心等等转机"},
        {"level": "末吉·震卦初六", "desc": "雷伏地中待时机，蓄势须忍莫冒进，守住根基不动摇，天时到来自奋起", "advice": "现在不是出手的好时候，先稳住别冒进，攒够实力再说，机会总会来的"},
    ]},
    {"score": 45, "items": [
        {"level": "末凶·坤卦初六", "desc": "六爻皆动变数多，此时静观胜躁进，忌见官讼与借贷，低调处事保平安", "advice": "今天变数比较多，别借钱也别签合同，低调做事就好，安安稳稳最重要"},
        {"level": "末凶·兑卦初六", "desc": "口舌是非纠缠多，言多必失需谨慎，今日出言须三思，祸从口出防小人", "advice": "今天说话要注意，别乱说容易惹麻烦，少说多做就对了，小心身边搬弄是非的人"},
    ]},
    {"score": 40, "items": [
        {"level": "末凶·震卦初九", "desc": "雷声滚滚震惊起，蛰伏待机莫轻动，今日诸事宜从缓，积蓄能量待时变", "advice": "今天啥事都别着急，能推后就推后，安静待着比瞎折腾强，休息也是一种进步"},
        {"level": "末凶·坎卦九二", "desc": "坎中有险需谨行，求小得小莫贪进，脚踏实地步步稳，方能渡过难关境", "advice": "别贪心，能拿到多少就多少，踏踏实实走稳每一步，小心一点就能过关"},
    ]},
    {"score": 30, "items": [
        {"level": "凶·离卦初九", "desc": "火星克命诸事滞，小人暗算须防备，出行避开南方位，见火之事不吉利", "advice": "今天出门小心点，别跟人起冲突，遇到找茬的人能躲就躲，忍让一下没坏处"},
        {"level": "凶·乾卦九三", "desc": "君子终日乾乾兢，多行多错少行安，反躬自省识时务，退守方能保无咎", "advice": "今天少做少错，做多了反而容易出问题，适合反思一下自己，安静待着最安全"},
    ]},
    {"score": 20, "items": [
        {"level": "大凶·乾卦上六", "desc": "亢龙有悔势已衰，孤立无援凶象来，今日切忌大动干戈，静守家中可避灾", "advice": "今天尽量别出门别惹事，待在家里最安全，遇到什么事情都软着来别硬刚"},
        {"level": "大凶·坤卦上六", "desc": "龙战于野血玄黄，天地交战难自保，诸事皆凶宜斋戒，默念平安保其身", "advice": "今天运气真的不太行，啥都别做了，宅家追追剧打打游戏，熬过今天明天会更好"},
    ]},
    {"score": 10, "items": [
        {"level": "极凶·坎卦上六", "desc": "系用徽纆陷丛棘，凶象已极四路绝，此签至凶勿出门，诚心向善可转圜", "advice": "今天真的很不顺，千万别出门别惹事，在家好好休息，做做好事积攒好运，明天一定会好起来"},
    ]},
]
...
async def _draw_card(theme: dict, data: dict, nickname: str, user_id: str,
    ...
    fn_cat    = F(15 * S)
    COL_W     = (W - PAD * 2) // 4
    BAR_SEG_W = 22 * S          # 每段横条宽度（缩小，使文字与条更对应）
    SEG_GAP   = 5 * S           # 段间距
    BAR_H     = 8 * S           # 条高
    BAR_TOTAL = 3 * BAR_SEG_W + 2 * SEG_GAP
    CV        = 16 * S          # 卡片纵向内边距
    LBL_H     = 20 * S          # 标签文字行高
    DIV_GAP   = 8 * S           # 分割线到进度条间距
    DIV_H     = 1 * S           # 分割线高度（1px @1x）
    CATS_H    = CV + LBL_H + 6 * S + DIV_H + DIV_GAP + BAR_H + CV
    _rrect(draw, (PAD, y, W - PAD, y + CATS_H), 18 * S, fill=card_bg + (255,))

    div_y   = y + CV + LBL_H + 6 * S          # 分割线顶边
    bar_top = div_y + DIV_H + DIV_GAP          # 进度条顶边

    for i, cat in enumerate(fortune["categories"]):
        col_x  = PAD + i * COL_W               # 列左边
        cx     = col_x + COL_W // 2            # 列中心x
        lbl_y  = y + CV + LBL_H // 2           # 标签垂直中心

        # 标签文字（居中）
        draw.text((cx, lbl_y), cat["name"], font=fn_cat,
                  fill=(95, 95, 100, 255), anchor="mm")

        # 标签下分割线（列宽 80%，居中）
        div_margin = COL_W // 10
        draw.rectangle(
            [col_x + div_margin, div_y,
             col_x + COL_W - div_margin, div_y + DIV_H],
            fill=card_border + (160,))
        ...
        for j in range(3):
            ...
            draw.rounded_rectangle(
                ...
                radius=4 * S, fill=bfill)
    y += CATS_H + GAP

    # ── 建议框 ──────────────────────────────────────────────────────────────
    # 文字左顶格对齐框内边缘，✨ 融入前缀文字
    fn_adv     = F(16 * S)
    ADV_PH     = 16 * S          # 框水平内边距（左右）
    ADV_PV     = 14 * S          # 框垂直内边距（上下）
    ADV_LH     = 26 * S          # 行高

    # 前缀 "✨ BotName：" 用主题色，后跟正文用深色
    prefix     = f"✨ {bot_name}："
    prefix_w   = _tw(draw, prefix, fn_adv)
    adv_body   = fortune["advice"] + "~"

    # 文字直接从框内左边距开始（左顶格）
    text_left  = PAD + ADV_PH
    text_max   = W - PAD - ADV_PH - text_left

    # 将 "前缀+正文" 整体换行，第一行要把 prefix 宽度计入已用
    adv_lines: List[Tuple[str, bool]] = []   # (文字片段, 是否包含前缀)
    first_max  = text_max - prefix_w
    body_lines = _wrap_text(draw, adv_body, fn_adv, max(first_max, text_max // 2))
    for li, ln in enumerate(body_lines):
        adv_lines.append((ln, li == 0))

    adv_h  = ADV_PV * 2 + len(adv_lines) * ADV_LH
    _rrect(draw, (PAD, y, W - PAD, y + adv_h), 18 * S,
           fill=advice_bg + (255,), outline=advice_bdr + (200,), lw=2 * S)

    for li, (ln, has_prefix) in enumerate(adv_lines):
        row_y = y + ADV_PV + li * ADV_LH
        if has_prefix:
            # 先画主题色的 "✨ BotName："
            draw.text((text_left, row_y), prefix,
                      font=fn_adv, fill=primary + (255,), anchor="lt")
            # 再画正文
            draw.text((text_left + prefix_w, row_y), ln,
                      font=fn_adv, fill=(55, 55, 60, 255), anchor="lt")
        else:
            draw.text((text_left, row_y), ln,
                      font=fn_adv, fill=(55, 55, 60, 255), anchor="lt")
    y += adv_h + GAP
